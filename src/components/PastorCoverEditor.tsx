...
// Botão para trocar a imagem/capa do Painel do Pastor.
// Sobe a imagem pelo mesmo endpoint da Galeria e salva a URL em ChurchSettings.
export default function PastorCoverEditor() {
  ...
  async function onFile(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      // 2) salva a URL como capa do Painel do Pastor (permissão checada no servidor)
      const save = await fetch("/api/pastor/cover", {
        method: "POST",
