      ...
      <SignUp.Root>
        ...
        >
          ...
          <div className='flex flex-col gap-2'>
            <span className='text-xs text-gray-500'>Você pertence a algum grupo? (opcional)</span>
          ...
          <Clerk.Field name="unsafeMetadata" className="hidden">
            <Clerk.Input type="hidden" value={JSON.stringify({ roles: selectedRoles })} />
          </Clerk.Field>

          <SignUp.Action submit className='bg-green-700 text-white my-1 rounded-md text-sm p-[10px]'>
            Cadastrar
          </SignUp.Action>

          <p className='text-xs text-center text-gray-600'>
            Já tem conta?{' '}
            <a href="/sign-in" className='text-green-700 font-semibold'>Entre aqui</a>
          </p>
        </SignUp.Step>
      </SignUp.Root>
    </div>
