...
// Apresentação da igreja (IPB Toledo). Reutilizada pela "Saiba Mais" (logada,
// showHero + backHref) e pela home pública de visitante (showHero=false).
export default function ChurchPresentation({
  ...
  return (
    <>
      ...
      <div className={`ab bg-gray-50 ${showHero ? "min-h-screen" : ""}`}>
