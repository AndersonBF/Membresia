...
const SubjectForm = ({
  ...
  useEffect(() => {
   ...
   const { members } = relatedData || { members: [] };
  ...
  return (
    <form className="flex flex-col gap-8" onSubmit={onSubmit}>
        ...
        <div className="flex flex-col gap-2 w-full md:w-1/4">
          ...
          >
            {members.map(
              (member: { id: string; nome: string; sobrenome: string }) => (
        ...
        {state.error && <span className="text-red-600">Algo está errado!</span>}
